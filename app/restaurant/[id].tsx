...
export default function RestaurantDetailScreen() {
    ...
    const loadData = useCallback(async () => {
        setLoading(true)
        await Promise.all([loadRestaurant(), loadReviews(), loadFavorite()])
        setLoading(false)
    }, [loadRestaurant, loadReviews, loadFavorite])
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['bottom']}>
            ...
            >
                ...
                <View style={styles.imageContainer}>
                    <Image
                        source={{
                            uri: restaurant.image || `https://placehold.co/800x400/F97316/FFFFFF?text=${encodeURIComponent(restaurant.name)}`,
                        }}
                        style={styles.image}
                        resizeMode="cover"
                    />
                ...
                <View style={styles.content}>
                    ...
                    {/* <CHANGE> Menu étudiant premium design - LA STAR DE L'APP */}
                    {restaurant.student_menu && restaurant.student_menu.length > 0 && (
                        <View style={styles.menuSection}>
                            ...
                            >
                                {restaurant.student_menu.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        {/* Titre du menu */}
                                        <Text style={[styles.premiumMenuTitle, { color: colors.text }]}>
                                            {item.title}
                                        </Text>
                            ...
                            {/* Info supplémentaire */}
                            <View style={[styles.menuFooter, { backgroundColor: `${colors.primary}10`, borderColor: colors.primary }]}>
...
const styles = StyleSheet.create({
    ...
    // <CHANGE> Nouveaux styles premium pour la section Menu Étudiant
    menuSection: {
        marginBottom: 32,
    },
    menuHeader: {
